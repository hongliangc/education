  ...
  return (
    <div className="relative rounded-3xl bg-white/80 p-4 text-center shadow-2xl ring-1 ring-white/70 backdrop-blur-xl">
      <button
        type="button"
        onClick={onClose}
        className="absolute right-2 top-2 flex h-11 w-11 items-center justify-center rounded-full bg-white/80 text-base font-black text-slate-500 ring-1 ring-slate-200 transition hover:bg-white focus-visible:ring-4 focus-visible:ring-sky-300"
        aria-label="关闭"
      >
        ✕
      </button>
